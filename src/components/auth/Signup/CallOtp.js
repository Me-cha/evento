...
//         <Toaster toastOptions={{ duration: 7000, position:"bottom-center"}} />
...
//                 <PhoneInput className={styles.phInput} country={"in"} value={ph} onChange={setPh} />
//                 <button
//                   onClick={onSignup}
...
//                 >
//                   {loading && (
//                     <CgSpinner size={20} className="mt-1 animate-spin" style={{color:"#fffff"}} />
//                   )}
